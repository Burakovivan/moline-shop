...
$_['text_minimum']             = 'от <span class="amount_lim">%s ед.</span> минимальный заказ';
...
$_['text1p']             = 'Место для информации о доставке товара';
$_['text2p']             = 'Место для информации об оплате товара';
$_['texth1p']            = 'ДОСТАВКА';
$_['texth2p']            = 'ОПЛАТА';
$_['asd'] = "Zxczxczxc";