...
class ModelCatalogProduct extends Model {
	...
	'recommended_wholesale_price'  => $query->row['recommended_wholesale_price'],
	...
	public function getProductsPriceRange($data = array()){
		$sql = "SELECT MAX(p.price) as max, MIN(p.price) as min";
		...
		if (!empty($data['filter_price'])){
			$sql .= " AND p.price >= " . $data['filter_price']['from'];
			$sql .= " AND p.price <= " . $data['filter_price']['to'];
		}
		...
		$sql = "SELECT MIN(glob_query.min) as min, MAX(glob_query.max) as max from (".$sql.") glob_query";
