...
class ControllerProductList extends Controller {
	...
	public function index($data) {
		...
		foreach($categories as $cat){
			$cat_path[] = $cat['category_id'];
		}
		$this->request->get['path'] = implode('_', $cat_path);
		...
		if ($product_info) {
			...
			if ($this->config->get('config_tax')) {
				$data['tax'] = $this->currency->format(is_numeric($product_info['special']) ? $product_info['special'] : $product_info['price'], $this->session->data['currency']);
			} else {
				$data['tax'] = false;
			}
