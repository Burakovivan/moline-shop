<?php
class ControllerCatalogQustion extends Controller {
	private $error = array();
	...
	public function index() {
		...
		// $this->load->model('catalog/information');
			...
			$this->response->setOutput($this->url->link('catalog/question_list', 'user_token=' . $this->session->data['user_token'], true));
			// $this->getList();
	}
	...
	protected function getList() {
		...
		$this->response->setOutput($this->load->view('catalog/question'/*, $data*/));
	}
